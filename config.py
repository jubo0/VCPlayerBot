...
class Config:
    ...
    ADMIN = os.environ.get("1844303560", '')
    SUDO = [int(admin) for admin in (ADMIN).split()] # Exclusive for heroku vars configuration.
    ADMINS = [int(admin) for admin in (ADMIN).split()] #group admins will be appended to this list.
    API_ID = int(os.environ.get("8686284", ''))
    API_HASH = os.environ.get("7110ae077d17a409b92718e44e9a4ad8", "")
    BOT_TOKEN = os.environ.get("5169334094:AAHgNDYr0xuyTtdYesJAhRgzdpVdz4PL4VY", "")     
    SESSION = os.environ.get("BQAMpEF7dsLL3Nbumt68EVJVqLmNRjP13GdNRmY2ZbSIZmpVDIJ4uMCs-xbEtcu8f4p0X7fO6hG2H9vBP2TWDdQkMEQ_GNwZ3hSguUTh_599LjM981jrZXR9oEu7OoPtk-Z-oowA2IZiO9fuUgMuoDWu-qKQqEOqMBlSk-MCyonoU6zDICb0iwFQEyavjvFHYUz8D8zA29p6hGurdI8TkoT_Jyj_8N0Q8VFPAfGvDO2HKYJUGDb5FTjirI-p4DxGAWn_Q_sUgS6FJ4GK4SZxHNuVhJVzNpRNYfOp2OdQb6iHlwE1mYPVyJsv9n0lFKhdtT7DsLmD8Wk8SU_BLabhOWmWAAAAASp-iUwA", "")

    #Stream Chat and Log Group
    CHAT = int(os.environ.get("-1001578688931", ""))
    LOG_GROUP=os.environ.get("-1001735800422", "")

    #Stream 
    STREAM_URL=os.environ.get("STARTUP_STREAM", "https://www.youtube.com/watch")
